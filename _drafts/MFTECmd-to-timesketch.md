---
layout: post
title: Using Timesketch to review MFTECmd.exe output
author: shanna
categories: Tools
image: assets/images/tools.png
tags: [ Timesketch, Tools, Getting-Started, EZTools, MFTECmd, MFT]
...
RTFM: <a href="https://timesketch.org/guides/admin/install/">Install Timesketch</a>

  ![Create new sketch]({{site.baseurl}}/assets/images/posts/MFT-Timesketch-1.png)


  ![Upload timeline]({{site.baseurl}}/assets/images/posts/MFT-Timesketch-2.png)

RTFM: <a href="https://timesketch.org/guides/user/upload-data/">https://timesketch.org/guides/user/upload-data/</a>
